<template>
  <div class="space-y-6">
    <div
      class="flex flex-col justify-between gap-4 rounded-lg border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm sm:flex-row sm:items-end"
    >
      <div class="flex flex-1 flex-col gap-4 sm:flex-row">
        ...
        <div class="w-full sm:w-48">
          ...
          <select
            ...
            class="block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-orange-500 focus:ring-orange-500 sm:text-sm"
          >
    ...
    <UiCard class="overflow-hidden">
            ...
            >
              ...
              >
                <button
                  ...
                  "
                  class="text-orange-600 dark:text-orange-400 hover:text-orange-600 focus:outline-none"
                  title="Télécharger"
                >
      ...
      <div
        v-if="totalPages > 1"
        class="flex items-center justify-between border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-3 sm:px-6"
      >
        <div
          ...
          <div>
            ...
            >
              <button
                ...
                class="relative inline-flex items-center rounded-l-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-2 py-2 text-sm font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 disabled:cursor-not-allowed disabled:opacity-50"
              >
              ...
              <button
                ...
                class="relative inline-flex items-center rounded-r-md border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 px-2 py-2 text-sm font-medium text-gray-500 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 disabled:cursor-not-allowed disabled:opacity-50"
              >
        ...
        <div class="mx-4 w-full max-w-lg rounded-xl bg-white dark:bg-gray-900 p-6 shadow-2xl">
          ...
          <div v-else class="max-h-96 space-y-3 overflow-y-auto">
            <button
              ...
              :key="apt.id"
              class="flex w-full items-center justify-between rounded-lg border border-gray-200 dark:border-gray-800 p-4 text-left transition-colors hover:border-orange-500 hover:bg-orange-50"
            ...
            >
              ...
              <div class="text-xs">
                <span
                  class="inline-flex rounded-full bg-gray-100 dark:bg-gray-800 px-2 font-semibold text-gray-800 dark:text-gray-200"
                >
                  {{
                ...
                <span
                  ...
                  class="ml-2 inline-flex rounded-full bg-green-100 dark:bg-green-900/30 px-2 font-semibold text-green-800 dark:text-green-200"
                  >Terminé</span
                >
                <span
                  v-else
                  class="ml-2 inline-flex rounded-full bg-orange-100 dark:bg-orange-900/30 px-2 font-semibold text-orange-800 dark:text-orange-200"
                  >Passé</span
                >
              </div>
            </button>
