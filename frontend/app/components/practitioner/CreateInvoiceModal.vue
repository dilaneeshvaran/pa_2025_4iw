      ...
      >
        <div class="w-full max-w-md rounded-xl bg-white dark:bg-gray-900 p-6 shadow-xl">
          ...
          <form @submit.prevent="submitPayment" class="space-y-4">
            <!-- patient info  -->
            <div v-if="appointment" class="mb-4 rounded-lg bg-gray-50 dark:bg-gray-900 p-3">
            ...
            <div
              v-if="errorMsg"
              class="rounded-md bg-red-50 dark:bg-red-950/30 p-3 text-sm text-red-700 dark:text-red-300"
            >
              {{ errorMsg }}
            </div>
