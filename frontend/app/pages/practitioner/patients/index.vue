  ...
  <div class="space-y-6">
    ...
    <div v-if="loading" class="space-y-4">
      ...
      >
        <div
          v-for="i in 6"
          :key="i"
          class="animate-pulse rounded-lg border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-gray-900"
        >
          ...
          <div class="mt-4 flex gap-2">
            <div class="h-8 w-20 rounded bg-gray-200 dark:bg-gray-700" />
            <div class="h-8 w-20 rounded bg-gray-200 dark:bg-gray-700" />
          </div>
        </div>
      </div>
      <div v-else class="animate-pulse space-y-2">
        <div
          v-for="i in 6"
          :key="i"
          class="h-16 rounded-lg border border-gray-200 bg-white dark:border-gray-800 dark:bg-gray-900"
        />
      </div>
    </div>
    ...
    >
      <div
        ...
        :key="patient.id"
        class="cursor-pointer rounded-lg border border-gray-200 bg-white p-5 shadow-sm transition-all hover:border-orange-300 hover:shadow-md dark:border-gray-800 dark:bg-gray-900"
        @click="openPatientDetail(patient.id)"
      >
        <div class="mb-3 flex items-start gap-3">
          <div
            class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-orange-100 dark:bg-orange-900/40"
          >
            <span
        ...
        <div class="mb-4 rounded-md bg-gray-50 px-3 py-2 dark:bg-gray-950">
          <div
            v-if="patient.nextAppointment"
            class="flex items-center gap-2 text-sm"
          >
            <Calendar
              class="h-3.5 w-3.5 flex-shrink-0 text-orange-500 dark:text-orange-400"
            />
            ...
            >
              <td class="whitespace-nowrap px-4 py-3">
                <div class="flex items-center gap-3">
                  <div
                    class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-orange-100 dark:bg-orange-900/40"
                  >
                    <span
