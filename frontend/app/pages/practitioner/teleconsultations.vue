  ...
  <div class="space-y-6">
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <UiCard>
        <div class="flex items-center gap-4">
          <div
            class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-yellow-100 dark:bg-yellow-900/30"
          >
      ...
      <UiCard>
        <div class="flex items-center gap-4">
          <div
            class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-lg bg-orange-100 dark:bg-orange-900/30"
          >
      ...
      <UiCard>
        <div class="flex items-center gap-4">
          ...
          <div>
            <p class="text-sm text-gray-500 dark:text-gray-400">Non présentés</p>
            <p
              v-if="loading"
              class="h-7 w-10 animate-pulse rounded bg-gray-200"
            />
      ...
      <div class="space-y-3">
        ...
        >
          <div class="flex items-center gap-4">
            ...
            <div>
              <p class="font-medium text-gray-900 dark:text-gray-100">{{ wp.patientName }}</p>
              <p class="text-sm text-gray-500 dark:text-gray-400">
    ...
    <UiCard v-if="activeTab === 'today'">
      ...
      <div v-else-if="todaySessions.length === 0" class="py-8 text-center">
        ...
        <p class="text-gray-500 dark:text-gray-400">Aucune téléconsultation prévue aujourd'hui</p>
      </div>
    ...
    <Teleport to="body">
      ...
      >
        <div class="mx-4 w-full max-w-3xl rounded-xl bg-white dark:bg-gray-900 shadow-2xl">
          ...
          <div class="border-b px-6 py-4">
            <div class="flex flex-wrap gap-3">
              ...
              <select
                ...
                class="rounded-lg border border-gray-300 dark:border-gray-700 px-3 py-2 text-sm focus:border-orange-500 focus:outline-none"
                @change="fetchHistory()"
              >
        ...
        <div class="mx-4 w-full max-w-lg rounded-xl bg-white dark:bg-gray-900 p-6 shadow-2xl">
          ...
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
              ...
              >
                <Camera
                  :class="preCallCamera ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'"
                  class="h-5 w-5"
                />
                <span class="text-sm">{{
              ...
              >
                <Mic
                  :class="preCallMic ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'"
                  class="h-5 w-5"
                />
                <span class="text-sm">{{
    ...
    <Teleport to="body">
      ...
      >
        <div class="mx-4 w-full max-w-md rounded-xl bg-white dark:bg-gray-900 p-6 shadow-2xl">
          ...
          <div class="mb-4">
            <label class="mb-2 block text-sm font-medium text-gray-700 dark:text-gray-300">Durée du retard (en minutes)</label>
            ...
            <div class="relative">
              ...
              />
              <span class="absolute right-3 top-2 text-sm text-gray-500 dark:text-gray-400">minutes</span>
            </div>
          </div>
          <p class="mb-4 rounded-lg bg-orange-50 dark:bg-orange-950/30 p-3 text-xs text-orange-700 dark:text-orange-300">
