    ...
    <div class="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
      <div>
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">
          Gérez vos moyens de paiement pour le règlement de votre abonnement et vos versements
        </p>
      </div>
      <button
        @click="showAddModal = true"
        class="inline-flex items-center justify-center gap-2 rounded-xl bg-orange-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all hover:bg-orange-700 active:scale-95"
      >
        <Plus class="h-4 w-4" />
