            ...
            <span
              ...
              :class="[
                ...
                dashboard.assignedTo.type === 'cabinet'
                  ? 'bg-purple-100/10 text-purple-700 border-purple-200/20'
                  : 'bg-[#D96F00]/10 text-[#D96F00] border-[#D96F00]/20',
              ]"
            >
              <component
    ...
    <div class="grid gap-6 lg:grid-cols-2">
      ...
      <UiCard>
        <div class="mb-4 flex items-center gap-2">
          <Users class="h-4 w-4 text-[#00804A]" :stroke-width="1.75" />
        ...
        <div v-else class="space-y-1">
          <NuxtLink
            ...
            class="flex items-center justify-between rounded-lg border border-transparent p-3 transition-all duration-150 hover:border-black/[0.05] hover:bg-gray-50"
          >
            <div class="flex items-center gap-3">
              <div
                class="flex h-9 w-9 items-center justify-center rounded-full bg-gray-100 text-xs font-semibold text-gray-600"
              >
            ...
            <div class="flex items-center gap-1.5 text-xs font-semibold text-[#00804A]">
      ...
      <UiCard>
        ...
        <div v-else-if="!loading" class="space-y-1">
          <div
            ...
            :key="apt.id"
            class="flex items-center justify-between rounded-lg border border-transparent p-3 hover:border-black/[0.05] hover:bg-gray-50"
          >
            <div>
