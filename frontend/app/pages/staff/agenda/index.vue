<template>
  <div class="space-y-6">
    ...
    <div v-else-if="!practitioners.length" class="py-12 text-center">
      <Users class="mx-auto mb-3 h-12 w-12 text-gray-300 dark:text-gray-600" />
    ...
    <div v-else class="space-y-3">
      <NuxtLink
        ...
        class="flex items-center justify-between rounded-xl border border-gray-200 bg-white p-5 shadow-sm transition-colors hover:bg-green-50 dark:border-gray-800 dark:bg-gray-900 dark:hover:bg-green-950/40"
      >
