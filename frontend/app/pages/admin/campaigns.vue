  ...
  <div class="space-y-6">
    ...
    <div v-if="activeTab === 'compose'" class="space-y-6">
      <UiCard>
        <h3 class="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">
          <Users
            class="mr-2 inline h-5 w-5 text-orange-600 dark:text-orange-400"
          />
          Destinataires
        </h3>
        ...
        <div class="space-y-3">
          ...
          >
            <input
              ...
              type="radio"
              :value="option.value"
              class="h-4 w-4 text-red-600 focus:ring-red-500 dark:text-red-400"
            />
            <div class="flex-1">
        ...
        <div
          ...
          class="mt-4 rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-950"
        >
          <h4
          ...
          <div class="grid gap-4 sm:grid-cols-3">
            <div>
              ...
              <select
                ...
                class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-red-500 focus:ring-red-500 dark:border-gray-700"
              >
        ...
        <div class="space-y-4">
          <div>
            ...
            <input
              ...
              class="w-full rounded-lg border border-gray-300 px-4 py-2.5 focus:border-red-500 focus:ring-red-500 dark:border-gray-700"
            />
          </div>
            ...
            <div class="space-y-2">
              <label class="flex items-center gap-3">
                <input
                  ...
                  type="checkbox"
                  class="h-4 w-4 rounded text-red-600 focus:ring-red-500 dark:text-red-400"
                />
              ...
              >
                <input
                  type="checkbox"
                  disabled
                  class="h-4 w-4 rounded text-gray-400 dark:text-gray-500"
                />
      ...
      <UiCard>
        ...
        <div class="grid gap-4 sm:grid-cols-3">
          <div
            class="rounded-lg bg-orange-50 p-4 text-center dark:bg-orange-950/40"
          >
          ...
          <div
            class="rounded-lg bg-green-50 p-4 text-center dark:bg-green-950/40"
          >
          ...
          <div
            class="rounded-lg bg-purple-50 p-4 text-center dark:bg-purple-950/40"
          >
    ...
    <div v-if="activeTab === 'history'" class="space-y-4">
        ...
        <div class="flex flex-wrap items-center gap-4">
          <div class="relative flex-1">
            ...
            <input
              ...
              class="w-full rounded-lg border border-gray-300 py-2 pl-10 pr-4 text-sm focus:border-red-500 focus:ring-red-500 dark:border-gray-700"
              @input="debouncedFetchHistory"
            />
          </div>
          <select
            v-model="historyStatusFilter"
            class="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-red-500 focus:ring-red-500 dark:border-gray-700"
            @change="fetchHistory()"
          >
      ...
      <div
        ...
        class="rounded-lg bg-gray-50 py-12 text-center text-gray-500 dark:bg-gray-950 dark:text-gray-400"
      >
        Aucun envoi trouvé
      </div>
      ...
      >
        <table class="w-full text-left text-sm">
          <thead
            class="bg-gray-50 text-xs uppercase text-gray-500 dark:bg-gray-950 dark:text-gray-400"
          >
            <tr>
        ...
        <div
          ...
          class="flex items-center justify-between border-t border-gray-200 bg-gray-50 px-4 py-3 dark:border-gray-800 dark:bg-gray-950"
        >
          ...
          <div class="flex gap-2">
            <button
              ...
              class="rounded border border-gray-300 px-3 py-1 text-sm disabled:opacity-50 dark:border-gray-700"
              @click="
                historyPage--;
                fetchHistory();
              "
    ...
    >
      <div
        class="max-h-[80vh] w-full max-w-2xl overflow-y-auto rounded-lg bg-white p-6 shadow-xl dark:bg-gray-900"
      >
        ...
        <div class="space-y-4">
          <div class="grid gap-4 sm:grid-cols-3">
            <div
              class="rounded-lg bg-orange-50 p-3 text-center dark:bg-orange-950/40"
            >
            ...
            <div
              class="rounded-lg bg-green-50 p-3 text-center dark:bg-green-950/40"
            >
            ...
            <div
              class="rounded-lg bg-red-50 p-3 text-center dark:bg-red-950/40"
            >
          ...
          <div>
            ...
            <div
              class="whitespace-pre-wrap rounded-lg bg-gray-50 p-3 text-sm text-gray-700 dark:bg-gray-950 dark:text-gray-300"
            >
          ...
          >
            ...
            >
              <table class="w-full text-left text-xs">
                <thead
                  class="bg-gray-50 text-gray-500 dark:bg-gray-950 dark:text-gray-400"
                >
                  <tr>
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                  ...
                  >
                    ...
                    <td class="px-3 py-2 text-red-500 dark:text-red-400">
                      {{ r.error || "" }}
                    </td>
                  </tr>
                </tbody>
...
const typeVariants: Record<string, string> = {
  INFO: "bg-orange-100 dark:bg-orange-900/40 text-orange-800 dark:text-orange-200",
  WARNING:
    "bg-yellow-100 dark:bg-yellow-900/40 text-yellow-800 dark:text-yellow-200",
  URGENT: "bg-red-100 dark:bg-red-900/40 text-red-800 dark:text-red-200",
  MAINTENANCE:
