<template>
  <div>
    ...
    <div class="mb-6 border-b border-gray-200 dark:border-gray-800">
      <nav class="-mb-px flex space-x-8">
        ...
        >
          ...
          <span
            v-if="pendingCount > 0"
            class="ml-2 inline-flex items-center rounded-full bg-yellow-100 px-2.5 py-0.5 text-xs font-medium text-yellow-800 dark:bg-yellow-900/40 dark:text-yellow-200"
          >
            {{ pendingCount }}
          </span>
        </button>
    ...
    <div class="mb-4 flex flex-wrap items-center gap-4">
      <select
        v-model="filterType"
        class="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 dark:border-gray-700"
      >
      ...
      />
      <button
        class="rounded-lg bg-gray-100 px-4 py-2 text-sm text-gray-700 transition-colors hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
        @click="
          filterType = '';
          filterSpecialty = '';
        "
          ...
          >
            ...
            <td class="whitespace-nowrap px-6 py-4">
              <div class="flex items-center gap-2">
                <button
                  class="rounded bg-gray-100 px-3 py-1.5 text-xs font-medium text-gray-700 transition-colors hover:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
    ...
    >
      <div
        class="max-h-[80vh] w-full max-w-2xl overflow-y-auto rounded-2xl bg-white p-6 shadow-xl dark:bg-gray-900"
      >
        <div class="mb-4 flex items-center justify-between">
          ...
          <button
            class="rounded-lg p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-600 dark:text-gray-500 dark:hover:bg-gray-800"
        ...
        <div class="space-y-4">
            ...
            <div class="border-t pt-4">
              ...
              <div class="space-y-2">
                <div
                  ...
                  class="flex items-center justify-between rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-800 dark:bg-gray-950"
                >
          ...
          >
            <h3
              class="mb-2 text-lg font-semibold text-red-700 dark:text-red-300"
            >
              Motif du rejet
            </h3>
            <p
              class="rounded-lg bg-red-50 p-3 text-sm text-red-800 dark:bg-red-950/40 dark:text-red-200"
            >
              {{ selectedRequest.rejectionReason }}
            </p>
          </div>
    ...
    >
      ...
      >
        ...
        <form @submit.prevent="submitReject">
          <div class="mb-4">
            ...
            >
              ...
              <span class="text-gray-400 dark:text-gray-500"
                >(min. 10 caractères)</span
              >
            </label>
            <textarea
              v-model="rejectionReason"
              rows="4"
              class="w-full rounded-lg border border-gray-300 px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-red-600 dark:border-gray-700"
          ...
          <div
            v-if="rejectError"
            class="mb-4 rounded-lg bg-red-50 p-3 text-sm text-red-800 dark:bg-red-950/40 dark:text-red-200"
          >
            {{ rejectError }}
          </div>
