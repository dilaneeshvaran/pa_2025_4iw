<template>
  <div>
      ...
      <div class="flex flex-wrap items-end gap-4">
        ...
        <div>
          ...
          <input
            ...
            min="0"
            placeholder="0"
            class="w-24 rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-orange-500 focus:outline-none focus:ring-1 focus:ring-orange-500 dark:border-gray-700"
            @change="fetchPatients"
          />
        </div>
    ...
    <div
      ...
      class="rounded-lg bg-red-50 p-4 text-red-800 dark:bg-red-950/40 dark:text-red-200"
    >
      {{ fetchError }}
    </div>
    ...
    <div
      ...
      class="rounded-lg border border-gray-200 bg-white py-12 text-center dark:border-gray-800 dark:bg-gray-900"
    >
      <AlertTriangle
        class="mx-auto mb-3 h-12 w-12 text-gray-300 dark:text-gray-600"
      />
      <p class="text-gray-500 dark:text-gray-400">
        Aucun patient avec absences trouvé
      </p>
    </div>
        ...
        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
          ...
          >
            ...
            <td class="px-4 py-3">
              <div class="relative">
                <button
                  class="rounded p-1 text-gray-400 hover:bg-gray-100 hover:text-gray-600 dark:text-gray-500 dark:hover:bg-gray-800"
    ...
    <Teleport to="body">
      <div
        v-if="openMenuId"
        class="fixed z-50 w-52 rounded-lg border border-gray-200 bg-white py-1 shadow-lg dark:border-gray-800 dark:bg-gray-900"
        :style="{
      ...
      >
        <button
          class="flex w-full items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50 dark:text-gray-300 dark:hover:bg-gray-800"
        ...
        <button
          ...
          "
          class="flex w-full items-center gap-2 px-4 py-2 text-sm text-yellow-700 hover:bg-yellow-50 dark:text-yellow-300 dark:hover:bg-yellow-950/40"
          @click="
        ...
        <button
          v-if="
            patients.find((p: any) => p.id === openMenuId)?.status !== 'banned'
          "
          class="flex w-full items-center gap-2 px-4 py-2 text-sm text-red-700 hover:bg-red-50 dark:text-red-300 dark:hover:bg-red-950/40"
        ...
        <button
          v-if="
            patients.find((p: any) => p.id === openMenuId)?.status === 'banned'
          "
          class="flex w-full items-center gap-2 px-4 py-2 text-sm text-green-700 hover:bg-green-50 dark:text-green-300 dark:hover:bg-green-950/40"
    ...
    >
      <div
        class="max-h-[85vh] w-full max-w-3xl overflow-y-auto rounded-xl bg-white p-6 shadow-xl dark:bg-gray-900"
      >
        ...
        <div v-else-if="historyData">
          <div class="mb-4 rounded-lg bg-gray-50 p-4 dark:bg-gray-950">
            ...
            <div
              ...
              "
              class="mt-3 rounded bg-red-50 p-2 text-sm text-red-700 dark:bg-red-950/40 dark:text-red-300"
            >
          ...
          <div class="mb-4 flex gap-2">
            <button
              ...
              class="flex items-center gap-1 rounded-lg bg-yellow-50 px-3 py-1.5 text-sm font-medium text-yellow-700 hover:bg-yellow-100 dark:bg-yellow-950/40 dark:text-yellow-300 dark:hover:bg-yellow-900/40"
            ...
            <button
              v-if="historyData.patient.status !== 'banned'"
              class="flex items-center gap-1 rounded-lg bg-red-50 px-3 py-1.5 text-sm font-medium text-red-700 hover:bg-red-100 dark:bg-red-950/40 dark:text-red-300 dark:hover:bg-red-900/40"
              :disabled="actionLoading"
            ...
            <button
              v-if="historyData.patient.status === 'banned'"
              class="flex items-center gap-1 rounded-lg bg-green-50 px-3 py-1.5 text-sm font-medium text-green-700 hover:bg-green-100 dark:bg-green-950/40 dark:text-green-300 dark:hover:bg-green-900/40"
              :disabled="actionLoading"
