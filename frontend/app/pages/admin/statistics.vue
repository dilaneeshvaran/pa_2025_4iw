  ...
  <div>
    <div class="mb-6 flex items-center justify-between">
      <div>
        ...
        <p class="text-gray-600 dark:text-gray-400">Vue d'ensemble de l'activité de la plateforme.</p>
      </div>
      <button
    ...
    <div v-else-if="data" class="space-y-8">
      ...
      <div class="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
        ...
        >
          ...
          <p v-if="kpi.sub" class="text-xs text-gray-500 dark:text-gray-400">{{ kpi.sub }}</p>
        </div>
      </div>
      ...
      <section class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5">
        ...
        <div class="flex h-48 items-end gap-2">
          ...
          >
            ...
            <span class="text-[10px] text-gray-500 dark:text-gray-400">{{ m.label }}</span>
          </div>
        </div>
      </section>
      ...
      <div class="grid gap-6 lg:grid-cols-2">
        ...
        <section class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5">
          ...
          <div class="space-y-3">
            ...
            >
              <div class="mb-1 flex justify-between text-sm">
                <span class="text-gray-700 dark:text-gray-300">{{ row.plan }}</span>
                <span class="font-medium text-gray-900 dark:text-gray-100">{{ row.count }}</span>
              </div>
              <div class="h-2 w-full rounded-full bg-gray-100 dark:bg-gray-800">
                <div
        ...
        <section class="rounded-xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-5">
          <h2 class="mb-4 text-lg font-semibold text-gray-900 dark:text-gray-100">Top villes</h2>
          <div class="space-y-3">
            <div v-for="row in data.topCities" :key="row.city">
              <div class="mb-1 flex justify-between text-sm">
                <span class="text-gray-700 dark:text-gray-300">{{ row.city }}</span>
                <span class="font-medium text-gray-900 dark:text-gray-100">{{ row.count }}</span>
              </div>
              <div class="h-2 w-full rounded-full bg-gray-100 dark:bg-gray-800">
                <div
            ...
            <p v-if="data.topCities.length === 0" class="text-sm text-gray-500 dark:text-gray-400">
              Aucune donnée
            </p>
          </div>
        </section>
...
const kpis = computed(() => {
  ...
  return [
    { label: "Utilisateurs", value: o.totalUsers, color: "text-gray-900 dark:text-gray-100", sub: "" },
    { label: "Patients", value: o.patients, color: "text-blue-600 dark:text-blue-400", sub: "" },
    {
      label: "Praticiens",
    ...
    { label: "Cabinets", value: o.cabinets, color: "text-purple-600 dark:text-purple-400", sub: "" },
    {
      label: "Rendez-vous",
