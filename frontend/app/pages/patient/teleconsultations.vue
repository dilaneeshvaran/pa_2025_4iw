  ...
  <div class="space-y-6">
    ...
    <UiCard>
      ...
      <div class="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
        <div
          class="flex items-center gap-2 rounded-lg bg-gray-50 p-3 dark:bg-gray-950"
        >
          <div
            :class="[
          ...
          >
            <div class="p-6">
              <div class="flex items-start gap-4">
                <div
                  class="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full bg-green-100 dark:bg-green-900/40"
                >
    ...
    <div v-if="activeTab === 'past'">
      ...
      <div
        ...
        class="rounded-lg border bg-white py-8 text-center dark:bg-gray-900"
      >
        <p class="text-gray-500 dark:text-gray-400">
          Aucune téléconsultation passée
        </p>
      </div>
      ...
      <div v-else>
        <div class="space-y-3">
          <div
            ...
            :key="apt.id"
            class="flex items-center justify-between rounded-lg border bg-white p-4 dark:bg-gray-900"
          >
            <div class="flex items-center gap-4">
              <div
                class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800"
              >
                <Video class="h-5 w-5 text-gray-400 dark:text-gray-500" />
              </div>
              <div>
