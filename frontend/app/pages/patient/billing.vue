    ...
    <div v-if="activeTab === 'invoices'">
      <div class="mb-4 flex flex-wrap items-center gap-3">
        <select
          ...
          class="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-orange-600 focus:outline-none dark:border-gray-700"
        >
      ...
      <div v-if="loadingPayments" class="space-y-4">
        <div
          v-for="i in 3"
          :key="i"
          class="animate-pulse rounded-lg border bg-white p-4 dark:bg-gray-900"
        >
      ...
      <div
        ...
        class="rounded-lg border bg-white py-12 text-center dark:bg-gray-900"
      >
        <Receipt
      ...
      <div v-else class="space-y-3">
        <div
          ...
          :key="payment.id"
          class="rounded-lg border bg-white p-4 transition-shadow hover:shadow-md dark:bg-gray-900"
        >
            ...
            <div class="flex flex-col items-end gap-2">
              ...
              <div class="flex gap-2">
                <button
                  ...
                  class="flex items-center gap-1 rounded-lg border border-gray-200 px-3 py-1.5 text-xs text-gray-600 transition-colors hover:bg-gray-50 dark:border-gray-800 dark:text-gray-400 dark:hover:bg-gray-800"
                  @click="
                ...
                <button
                  ...
                  class="flex items-center gap-1 rounded-lg border border-orange-200 px-3 py-1.5 text-xs text-orange-600 transition-colors hover:bg-orange-50 dark:text-orange-400 dark:hover:bg-orange-950/40"
          ...
          <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              <button
                ...
                class="rounded-lg border border-orange-200 px-3 py-1.5 text-xs text-orange-600 transition-colors hover:bg-orange-50 dark:text-orange-400 dark:hover:bg-orange-950/40"
              ...
              <button
                ...
                class="rounded-lg border border-gray-200 px-3 py-1.5 text-xs text-gray-600 transition-colors hover:bg-gray-50 dark:border-gray-800 dark:text-gray-400 dark:hover:bg-gray-800"
                @click="setDefault(method.id)"
              >
                Par défaut
              </button>
              <button
                class="rounded-lg border border-red-200 p-1.5 text-red-500 transition-colors hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-950/40"
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          ...
          <div v-if="newMethodType === 'CARD'" class="space-y-4">
            <div>
              ...
              <input
                ...
                maxlength="19"
                class="mt-1 w-full rounded-lg border border-gray-300 px-4 py-2.5 focus:border-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-600 dark:border-gray-700"
              />
            </div>
            <div class="grid grid-cols-3 gap-3">
              <div>
                ...
                <select
                  ...
                  class="mt-1 w-full rounded-lg border border-gray-300 px-3 py-2.5 focus:border-orange-600 focus:outline-none dark:border-gray-700"
                >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="XXX"
                  maxlength="4"
                  class="mt-1 w-full rounded-lg border border-gray-300 px-4 py-2.5 focus:border-orange-600 focus:outline-none dark:border-gray-700"
                />
              </div>
            </div>
          </div>
          ...
          <div
            v-if="addMethodError"
            class="mt-3 rounded-lg bg-red-50 p-3 text-sm text-red-600 dark:bg-red-950/40 dark:text-red-400"
          >
            {{ addMethodError }}
          </div>
      ...
      >
        ...
        >
          ...
          <input
            ...
            maxlength="8"
            class="mb-4 w-full rounded-lg border border-gray-300 px-4 py-2.5 text-center text-lg tracking-widest focus:border-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-600 dark:border-gray-700"
          />
          <div
            v-if="verifyError"
            class="mb-3 rounded-lg bg-red-50 p-3 text-sm text-red-600 dark:bg-red-950/40 dark:text-red-400"
          >
            {{ verifyError }}
          </div>
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          ...
          <div
            class="mb-4 rounded-lg bg-yellow-50 p-4 text-sm text-yellow-800 dark:bg-yellow-950/40 dark:text-yellow-200"
          >
          ...
          <div
            v-if="refundSuccess"
            class="mb-3 rounded-lg bg-green-50 p-3 text-sm text-green-700 dark:bg-green-950/40 dark:text-green-300"
          >
            {{ refundSuccess }}
          </div>
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          ...
          <div class="mb-6 rounded-lg bg-gray-50 p-4 dark:bg-gray-950">
          ...
          <div class="mb-6">
            ...
            <div class="space-y-3">
              <label
                ...
                :class="
                  selectedPaymentMethod === method.id
                    ? 'border-orange-500 bg-orange-50 ring-1 ring-orange-500 hover:bg-orange-50 dark:bg-orange-950/40 dark:hover:bg-orange-950/40'
              ...
              <div
                ...
                class="rounded-lg bg-gray-50 p-4 text-center text-sm text-gray-600 dark:bg-gray-950 dark:text-gray-400"
              >
                Aucun moyen de paiement vérifié.
                <button
                  type="button"
                  class="mt-2 block w-full text-orange-600 hover:underline dark:text-orange-400"
                  @click="
          ...
          <div
            v-if="paymentError"
            class="mb-4 rounded-lg bg-red-50 p-3 text-sm text-red-600 dark:bg-red-950/40 dark:text-red-400"
          >
            {{ paymentError }}
          </div>
