<template>
  <div class="space-y-6">
    <div class="flex items-center justify-between">
      <div>
        <h1 class="mb-2 text-2xl font-bold text-gray-900 dark:text-gray-100">Personnel</h1>
        <p class="text-gray-600 dark:text-gray-400">Gérez le personnel de votre cabinet</p>
      </div>
      <button
              ...
              <div class="mt-1 flex items-center gap-2">
                <template v-if="editingId === staff.id">
                  ...
                  <button
                    ...
                    class="rounded p-0.5 text-green-600 dark:text-green-400 hover:bg-green-50"
                    title="Enregistrer"
                  >
                  ...
                  <button
                    @click="cancelEdit"
                    class="rounded p-0.5 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800"
                    title="Annuler"
                  >
                    <X class="h-3.5 w-3.5" />
                  </button>
                ...
                <template v-else>
                  ...
                  <button
                    ...
                    class="rounded p-0.5 text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-orange-600"
...
const removeStaff = async (id: string) => {
  ...
  try {
    await useAuthenticatedFetch(`/cabinet/staff/${id}`, {
      method: "DELETE",
    });
