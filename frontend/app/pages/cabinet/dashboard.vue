  ...
  <div>
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div class="rounded-2xl border border-[#E5E3DC] border-t-2 border-t-[#00804A]/30 bg-white dark:bg-gray-900 p-5 shadow-sm hover:shadow-md transition-all duration-300">
        <div class="flex items-start justify-between">
          <div>
            <p class="text-[10px] font-medium uppercase tracking-widest text-gray-500 dark:text-gray-400">Praticiens</p>
            <p
              v-if="loading"
      ...
      <div class="rounded-2xl border border-[#E5E3DC] border-t-2 border-t-[#D96F00]/30 bg-white dark:bg-gray-900 p-5 shadow-sm hover:shadow-md transition-all duration-300">
        <div class="flex items-start justify-between">
          <div>
            <p class="text-[10px] font-medium uppercase tracking-widest text-gray-500 dark:text-gray-400">Personnel</p>
            <p
              v-if="loading"
              class="mt-1 h-8 w-12 animate-pulse rounded bg-gray-200"
            ></p>
      ...
      <div class="rounded-2xl border border-[#E5E3DC] border-t-2 border-t-[#00804A]/30 bg-white dark:bg-gray-900 p-5 shadow-sm hover:shadow-md transition-all duration-300">
        <div class="flex items-start justify-between">
          <div>
            <p class="text-[10px] font-medium uppercase tracking-widest text-gray-500 dark:text-gray-400">RDV aujourd'hui</p>
            <p
              v-if="loading"
              class="mt-1 h-8 w-12 animate-pulse rounded bg-gray-200"
            ></p>
    ...
    <UiCard>
      ...
      >
        ...
        <p class="mt-1 max-w-[280px] text-sm text-gray-500 dark:text-gray-400">Aucun praticien dans ce cabinet.</p>
        <UiButton
          variant="outline"
          size="sm"
          class-name="mt-4"
      ...
      <div v-else class="space-y-1">
        <div
          ...
          :key="prac.id"
          class="flex items-center justify-between rounded-lg border border-transparent p-3 hover:border-black/[0.05] hover:bg-gray-50 dark:hover:bg-gray-800 transition-all duration-150"
        >
          <div class="flex items-center gap-3">
            <div
              class="flex h-9 w-9 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800 text-xs font-semibold text-gray-600 dark:text-gray-400 shadow-inner"
            >
              <span>
