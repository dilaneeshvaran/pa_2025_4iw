...
describe('status utils', () => {
  ...
  describe('getTeleconsultationStatusBadgeVariant', () => {
    it("retourne 'success' pour IN_PROGRESS", () => {
      expect(getTeleconsultationStatusBadgeVariant('IN_PROGRESS')).toBe('success')
    })
    ...
    it("retourne 'warning' pour SCHEDULED", () => {
      expect(getTeleconsultationStatusBadgeVariant('SCHEDULED')).toBe('warning')
    })

    it("retourne 'primary' pour COMPLETED", () => {
      expect(getTeleconsultationStatusBadgeVariant('COMPLETED')).toBe('primary')
    })
