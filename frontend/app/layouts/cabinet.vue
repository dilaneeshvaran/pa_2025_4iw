      ...
      <div class="flex h-full flex-col">
        ...
        <div class="flex items-center border-b border-gray-100 dark:border-gray-800">
          ...
          >
            ...
            <span class="rounded-full bg-[#D96F00]/10 px-2 py-0.5 text-[10px] font-medium text-[#D96F00] dark:text-orange-300">Cabinet</span>
          </NuxtLink>
          <button
            type="button"
        ...
        <div class="border-t border-gray-100 dark:border-gray-800 p-4">
          <div class="mb-3 flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
              ...
              <span class="inline-flex items-center rounded-full bg-[#D96F00]/10 px-2 py-0.5 text-[10px] font-medium text-[#D96F00] dark:text-orange-300">Cabinet Admin</span>
            </div>
          </div>
          <button
            @click="handleLogout"
