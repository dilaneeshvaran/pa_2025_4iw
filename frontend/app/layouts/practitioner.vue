    ...
    >
      <div class="flex h-full flex-col">
        ...
        <nav class="flex-1 overflow-y-auto px-3 py-4" aria-label="Navigation principale">
          <p class="px-3 pb-2 pt-1 text-[10px] font-medium uppercase tracking-[0.12em] text-gray-500 dark:text-gray-400">Espace praticien</p>
        ...
        <div class="border-t border-gray-100 dark:border-gray-800 p-4">
          <div class="mb-3 flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
              ...
              <span class="inline-flex items-center rounded-full bg-[#00804A]/10 px-2 py-0.5 text-[10px] font-medium text-[#00804A] dark:text-green-300">Praticien</span>
            </div>
          </div>
          <button
            @click="handleLogout"
