      ...
      <div class="flex h-full flex-col">
        ...
        >
          ...
          <div class="flex flex-col">
            ...
            <span class="text-[9px] font-bold text-gray-400 uppercase tracking-widest mt-1">Personnel</span>
          </div>
        </NuxtLink>
        ...
        <div class="border-t border-[#E5E3DC]/40 p-4 bg-[#FAF9F6]/40 rounded-b-2xl">
          <div class="mb-3 flex items-center gap-3">
            ...
            >
              <ClipboardList class="h-4.5 w-4.5 text-green-600" />
            </div>
            <div class="min-w-0 flex-1">
              <p class="truncate text-xs font-bold text-[#1B2321]">
                {{ authStore.user?.email }}
              </p>
              <p class="text-[10px] font-semibold text-[#8C897E] uppercase tracking-wider">Personnel</p>
            </div>
          </div>
          <button
            @click="handleLogout"
